...
import {View, StyleSheet,Text,Image ,ScrollView,TouchableOpacity,ImageBackground,TouchableWithoutFeedback} from 'react-native';
                            ...
                            >
                                <View style={styles.bodyBox}>
                                    <View style={styles.bodyBoxHeader}>
                                        <Text style={styles.bodyBoxHeaderTitle}>Thú Cưng</Text>
                                    </View>
                                    <View style={styles.bodyBoxItem}>
                                        {pets.map((pet,index)=>(
                                            <TouchableWithoutFeedback key={index} onPress={()=>navigation.navigate('ProfilePet',pet._id)}>
                                                <View  style={styles.dataItem}>
                                                    <Image source={{uri:pet.avatar}} style={{width:140,height:140,borderRadius:15}}/>
                                                    <View style={{height:140,marginLeft:10}}>
                                                        <Text ellipsizeMode="tail" numberOfLines={1} style={styles.dataItemLabel}>{pet.namePet}</Text>
                                        ...
                                        <TouchableWithoutFeedback onPress={()=>onPressAddPet()}>
                                        <View style={styles.dataItem}>
                                            <FontAwesome5 name="plus-circle" style={{color:'gray',marginHorizontal:15}} size={100}/>
                                            <Text ellipsizeMode="clip" numberOfLines={1} style={[styles.dataItemLabel,{fontSize:25}]}>Thêm Thú Cưng</Text>
                                        </View>
                                        </TouchableWithoutFeedback>
                                    </View>
                                </View>
